...
// Include tasks
#include "tasks\task0_convert_the_file_into_infix.cpp"
...
int main() {
    ...
    cout << "Do you want to enter formulas manually(m) or generate randomly(r) or give a cnf file(f)? (m/r/f): ";
    char choice;
    cin >> choice;
    cin.ignore();
    ...
    try {
        ...
        bool isValidCnf = isValid(root, validCount, invalidCount);
        cout << "\nStep 5 - isValid:\n" << isValidCnf << endl;
        ...
        if (advChoice == 'y' || advChoice == 'Y') {
            ...
            cout << "negationNode probability (0.0 - 1.0): ";
            cin >> negProb;
